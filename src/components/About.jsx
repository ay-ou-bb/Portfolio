...
useEffect(()=>{
    ...
    return(
         <RevealOnScroll>
            <div id="about" className="relative flex justify-center items-center  mb-16 md:mb-24">
                <div className=" flex max-md:flex-col justify-center md:justify-around items-center gap-6  w-5/6 p-6  shadow-2xl">
                    <div >
