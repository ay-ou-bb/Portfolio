    ...
    return(
        <div id="contact" className="text-black flex justify-center items-center  w-full h-full " onClick={handleDivClick}>
            <div className=" mb-16 mt-16  w-[90%]  flex flex-col-reverse md:flex-row-reverse  justify-around items-center border border-gray-400 border-solid p-2 md:p-8">
                ...
                ref={form}
                 ...
                 method="POST" */}
                    ...
                    <div className="mb-4 w-[100%] md:w-[80%] flex flex-col items-start "> 
                        <lable className="mb-1">{t("contact.name")}</lable>
                        <input
                        type="text"
                        name="name"
                        required
                    ...
                    <div className="mb-4 w-[100%] md:w-[80%] flex flex-col items-start ">
                        <lable className=" mb-1 ">{t("contact.email")}</lable>
                        <input
                        type="email"
                        name="email"
                        required
                    ...
                    <div className="mb-4 flex w-[100%] md:w-[80%] flex-col items-start ">
                        <lable className=" mb-1 ">{t("contact.message")}</lable>
                        <textarea 
                ...
                <div className=" w-[90%] md:w-[50%] md:h-[300px] flex flex-col items-center justify-start  mb-12 md:mb-0">
                    <h1 className="mb-4 text-3xl md:text-4xl  lg:text-5xl text-start">{t("contact.contact")}</h1>
                    <p className="text-sm md:text-base lg:text-lg font-normal">{t("contact.description")}</p>
                </div>
            </div>
        </div>
    )
