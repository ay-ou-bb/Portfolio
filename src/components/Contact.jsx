export default function Projects(){
    return(
        <div className="mt-24 mb-24 flex justify-center items-center  ">
            <div className="  w-[90%]  flex flex-col-reverse md:flex-row-reverse  justify-around items-center border border-gray-400 border-solid p-8">
                <form className=" mb-16 md:mb-0 w-[90%]  md:w-[40%] flex flex-col justify-center items-center">
                    <div className="mb-4 w-[80%] flex flex-col items-start "> 
                    ...
                    <div className="mb-4 flex w-[80%] flex-col items-start ">
                ...
                <div className=" w-[90%] md:w-[50%] h-[300px] flex flex-col items-center justify-start">
                    <h1 className="mb-8">Contact us</h1>
                    <p>fell free to reach out if you have a project in mind, a question about my work, or simply want to connect. I'm always open to discussing new ideas and opportunities</p>
                </div>
            </div>
        </div>
    )
