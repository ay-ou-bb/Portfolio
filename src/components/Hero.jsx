...
export default function Hero(){
    ...
    return(
        <RevealOnScroll>
            <Container maxWidth={false} sx={{backgroundColor:theme=>theme.palette.primary.light}}  id="home" className="z-10 w-full flex justify-center items-center  flex-col  text-white ">
