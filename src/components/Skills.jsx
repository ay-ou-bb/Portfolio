        ...
        <div id="skills" className="w-full flex flex-col justify-center items-center mb-16 md:mb-24">
            ...
            <RevealOnScroll>
                <div className="flex flex-col-reverse md:flex-row w-full justify-center items-center">
                    ...
                    <div style={{backgroundColor:theme.palette.primary.light}} className="w-[80%] md:w-[40%] p-6 md:p-16 md:mt-0 md:ml-16 bg-[#3B82F6] text-[#F8FAFC] rounded-xl shadow-[5px_10px_15px_rgba(0,0,0,0.25)] text-center">
