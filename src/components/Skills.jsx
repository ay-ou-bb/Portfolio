...
export default function Skills(){
    ...
    return(
        ...
        <div id="skills" className="w-full flex flex-col justify-center items-center mt-16">
            <h1 style={{color:theme.palette.secondary.dark,}} className=" font-bold text-2xl md:text-3xl md:mb-4 lg:text-4xl drop-shadow-[2px_5px_2px_rgba(59,130,246,1)]">{t("skills.title")}</h1>
            <div className="flex flex-col-reverse md:flex-row w-full justify-center items-center">
                ...
                <div className="w-[80%] md:w-[40%] p-6 md:p-16 mt-16 md:mt-0 md:ml-16 bg-[#3B82F6] text-[#F8FAFC] rounded-xl shadow-[5px_10px_15px_rgba(0,0,0,0.25)]">
                    <h1 className="mb-8 text-3xl md:text-4xl  lg:text-5xl">{t("skills.Overview")}</h1>
